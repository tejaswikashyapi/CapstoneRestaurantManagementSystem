...
namespace RestaurantManagementsystem.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public async Task<IActionResult> SummaryPost(string stripeToken)
        {
            ...
            {
                await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == claim.Value).FirstOrDefault().Email, "RestaurantManagementsystem - Order Created - ID:" + detailCart.OrderHeader.ID.ToString(), "Order has been submitted succesfully.");
