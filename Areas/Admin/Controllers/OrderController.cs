...
namespace RestaurantManagementsystem.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> OrderReady(int OrderId)
        {
            ...
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserID).FirstOrDefault().Email, "RestaurantManagementsystem - Order Ready for Pickup - ID:" + orderHeader.ID.ToString(), "Your Order is ready for Pickup.");
        ...
        public async Task<IActionResult> OrderCancel(int OrderId)
        {
            ...
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserID).FirstOrDefault().Email, "RestaurantManagementsystem - Order Cancelled - ID:" + orderHeader.ID.ToString(), "Your Order has been cancelled.");
            await _db.SaveChangesAsync();
            return RedirectToAction("ManageOrder", "Order");
        }
        ...
        public async Task<IActionResult> OrderPickupPost(int orderId)
        {
            ...
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserID).FirstOrDefault().Email, "RestaurantManagementsystem - Order Completed - ID:" + orderHeader.ID.ToString(), "Your Order has been completed succesfully!");
