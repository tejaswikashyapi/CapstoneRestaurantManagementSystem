...
namespace RestaurantManagementsystem.Data.Migrations
{
    ...
    [Migration("20210205191325_AddOrderHeaderAndDetailsToDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestaurantManagementsystem.Models.Coupon", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RestaurantManagementsystem.Models.OrderDetails", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RestaurantManagementsystem.Models.OrderHeader", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RestaurantManagementsystem.Models.ShoppingCart", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RestaurantManagementsystem.Models.MenuItem", b =>
                {
                    ...
                    b.HasOne("RestaurantManagementsystem.Models.SubCategory", "SubCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("RestaurantManagementsystem.Models.OrderDetails", b =>
                {
                    ...
                    b.HasOne("RestaurantManagementsystem.Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("RestaurantManagementsystem.Models.OrderHeader", b =>
                {
                    b.HasOne("RestaurantManagementsystem.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
